const CONFIG = {
  ...
  reports: {
    ...
    humanEdge: {
      ...
      b3: { read: "Your human edge is doing real work. You read people accurately, you adapt, and it shows in how things go. This is the part of your OS where human judgment still does the deciding.", nextStep: "Think of the room where you're least comfortable reading people. Before you're next in it, write down what you predict: who'll dominate, who'll go quiet, what won't get said. Afterwards, check. Calibration is the skill." },
