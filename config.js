const CONFIG = {
  ...
  disclaimer: "A reflection tool, not a psychometric test - a snapshot to think with. Want to go deeper on self-awareness? See the validated instruments rounded up here →",
  ...
  questions: [
    ...
    { pillar: "mindset", sub: "1.1 Self-Awareness", component: "c11",
      text: "When something rattles you at work, which sounds most like you?",
      options: [
        "I mostly just feel it. The reaction arrives; naming what's underneath isn't really on the menu.",
        "Afterwards, I can usually work out what was going on. In the moment, not so much.",
        "I often catch the pattern as it's happening. I know my triggers and can name what's driving me.",
        "I flag my own biases out loud before they steer the room - \"ignore me, that's my impatience talking\" - and people trust me more for it." ] },
    { pillar: "mindset", sub: "1.2 Mental Models", component: "c12",
      text: "The beliefs your career runs on - what's realistic, what's allowed, what's \"just how things are.\" When did you last look at one directly?",
      options: [
        ...
        "I audit them on purpose. \"Is this still true?\" has retired more than one.",
        "I question assumptions out loud - and people bring me theirs: \"tell me what I'm not seeing.\"" ] },
    { pillar: "mindset", sub: "1.3 Emotional Literacy", component: "c13",
      ...
      options: [
        "\"Stressed\" or \"fine.\" That's most of the vocabulary, honestly.",
        "I can name more if I sit with it, but my first label is usually a blur word.",
        "I can usually name it precisely, even mid-situation - and the naming changes what I do next.",
        "Precise naming is reflex now, and I lend it to others: \"you sound more cornered than angry.\"" ] },
    { pillar: "mindset", sub: "1.4 Cognitive Reframing / Psychological Flexibility", component: "c14",
      text: "A plan you were committed to stops working. What actually happens next?",
      options: [
        "I push harder on the plan. Changing course feels like failure, so I defend it.",
        "I adapt eventually - after more sunk cost than I'd like to admit.",
        "I notice early, loosen my grip, and adjust without much drama.",
        "Colleagues call me when the ground shifts. Holding plans lightly is what I'm known for." ] },
    { pillar: "mindset", sub: "1.5 Growth Mindset", component: "c15",
      text: "You're visibly bad at something new. What's the inner monologue?",
      options: [
        "\"Not my thing.\" And quietly, \"too late for me\" has made appearances.",
        "I know the \"not yet\" theory. Believing it mid-struggle is another matter.",
        "\"Not yet\" is genuinely how it reads. Being a beginner stopped being an emergency.",
        "I pick fights with my own incompetence on purpose - and people around me have noticed it's safe to be a learner here." ] },
    { pillar: "mindset", sub: "1.6 Identity Flexibility", component: "c16",
      text: "Complete the sentence honestly: \"I'm the kind of person who...\" How much room is left in that sentence?",
      options: [
        "Not much. The sentence was finished years ago - title, track record, done.",
        "I sense some stories are outdated. Updating them feels like losing something.",
        "My stories have version numbers. \"I'm someone who's becoming...\" rings true, even if I'd phrase it my own way.",
        "I've rewritten the sentence in public, more than once - and people around me update theirs faster for having watched." ] },
    { pillar: "mindset", sub: "1.7 Reinvention Mindset", component: "c17",
      text: "A new version of you - a role, a skill, a direction - is somewhere on the horizon. What's actually happening with it?",
      options: [
        "It stays on the horizon. The current version is who I am; stepping out feels like pretending.",
        "I think about it a lot. Thinking is mostly where it lives.",
        "It's getting small, real experiments - low stakes, actual reps, identity catching up through the doing.",
        "I've stepped into new versions often enough that people ask me how. Reinvention is a muscle now, not a crisis." ] },
    { pillar: "mindset", sub: "1.8 Agency & Ownership", component: "c18",
      text: "Your work life: who's driving?",
      options: [
        "Circumstances, mostly. Things happen to me, and I respond - when someone says it's okay to.",
        "I have the wheel in theory. In practice I wait - for permission, for the reorg, for someone to go first.",
        "I'm driving. \"What's in my control?\" is the reflex - and the permission I need is mostly mine to give.",
        "People hand me stuck things because they unstick - and they come to me to hear \"you don't need anyone's blessing. Go.\"" ] },
    { pillar: "mindset", sub: "1.9 Values", component: "c19",
      text: "Everything around you is shifting: role, tools, plans. What's your footing like?",
      options: [
        "When things move, all of me moves. I get swept, and it shows.",
        "I have values, vaguely. I've never quite pinned down what's non-negotiable.",
        "I know what I'm not willing to compromise. It's carried me through real turbulence.",
        "My anchors are visible from the outside. People can predict where I'll stand, and they plan around it." ] },
